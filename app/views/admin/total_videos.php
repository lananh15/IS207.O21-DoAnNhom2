...
<?php require_once $_SERVER["DOCUMENT_ROOT"] .  '/IS207.O21-DoAnNhom2/app/controllers/Stats_TotalVideos.php'; ?>
...
<section class="dashboard">
   ...
   <h1 class="heading">Total Videos</h1>

   <div class="box-container">

   <div class="box">
      <h3><?= get_number_of_movies($conn); ?></h3>
      <p>Movies</p>
      <a href="view_movies.php" class="btn">See Movies</a>
   </div>

   <div class="box">
      <h3><?= get_number_of_trailers($conn); ?></h3>
      <p>Trailers</p>
