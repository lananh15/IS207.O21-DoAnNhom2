...
<?php require_once $_SERVER["DOCUMENT_ROOT"] .  '/IS207.O21-DoAnNhom2/app/controllers/Stats_TotalReactions.php'; ?>
...
<section class="dashboard">
   ...
   <h1 class="heading">Total Reactions</h1>

   <div class="box-container">

   <div class="box">
      <h3><?= get_number_of_movie_likes($conn); ?></h3>
      <p>Movie Likes</p>
      <a href="view_movies.php" class="btn">See Movies</a>
   </div>

   <div class="box">
      <h3><?= get_number_of_trailer_likes($conn); ?></h3>
      <p>Trailer Likes</p>
      <a href="view_trailers.php" class="btn">See Trailers</a>
   </div>

   <div class="box">
      <h3><?= get_number_of_movie_dislikes($conn); ?></h3>
      <p>Movie Dislikes</p>
      <a href="view_movies.php" class="btn">See Movies</a>
   </div>

   <div class="box">
      <h3><?= get_number_of_trailer_dislikes($conn); ?></h3>
      <p>Trailer Dislikes</p>
      <a href="view_trailers.php" class="btn">See Trailers</a>
   </div>
